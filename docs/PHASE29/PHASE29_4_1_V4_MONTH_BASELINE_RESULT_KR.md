...
|------|------|
| **PHASE** | PHASE29-4.1 |
| **작성일** | 2025-12-10 (최종 업데이트: 2025-12-11) |
| **상태** | ✅ **COMPLETE** |
| **판정** | ⚠️ **AC1/AC2 PASS, AC3 FAIL** (Win Rate/Max DD 기준 미달) |
...
- ❌ AC3: Win Rate >= 45%, Max DD <= 15% (**FAIL**, PHASE29-6에서 재검증)
...
❌ **FAIL** - V4 전략은 2024년 11월 BTC 시장에서 성능 기준 미달:
- Win Rate가 목표(45%)보다 17.14%p 낮음
- Max Drawdown이 목표(15%)보다 8.21%p 높음
- 전반적으로 손실 발생 (-22.45% ROI)

**원인 분석**:
1. 시장 변동성이 전략 가정과 불일치
2. 손실 비율이 너무 높음 (72.14%)
3. R:R 비율이 불리함 (Profit Factor 0.525)

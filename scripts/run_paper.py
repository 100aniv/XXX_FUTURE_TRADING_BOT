...
# -*- coding: utf-8 -*-
"""
PHASE23-3: Paper Trading Thin Wrapper
======================================
REAL Paper Mode용 얇은 래퍼 - engine.run_v2() 호출만 담당

Usage:
    python scripts/run_paper.py --config configs/paper/xxx.yml
    python scripts/run_paper.py --config configs/paper/xxx.yml --duration-hours 2
    python scripts/run_paper.py --config configs/paper/xxx.yml --clean-state
...
logger = setup_logger("run_paper")


def parse_args():
    """CLI 인자 파싱"""
    parser = argparse.ArgumentParser(
        description='PHASE23-3: Paper Trading Thin Wrapper (run_v2 호출)',
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help='Config YAML 파일 경로 (예: configs/paper/xxx.yml)'
    )

        ...
        with conn.cursor() as cur:
            ...
            cur.execute("""
                SELECT
                    ...
                    strategy_id
                FROM trading.trades
                WHERE created_at >= '2025-12-08 00:50:00'
                  AND created_at < '2025-12-08 00:56:00'
                ORDER BY created_at
            """)
            ...
            # 결과 출력
            print("\n" + "=" * 80)
            print("📊 BEAR Period 백테스트 결과 (2024-08-01 ~ 2024-08-31)")
            print("=" * 80)
            ...
            # JSON 저장
            results = {
                'run_id': 'phase28_8_btc5m_baseline_v2_bear',
            ...
            output_file = 'reports/backtest/phase28_8/baseline_bear.json'
